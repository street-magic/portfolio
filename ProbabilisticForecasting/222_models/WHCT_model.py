...
def train(material_name, customer_name, data_sales, output_path = ''):
    ...
    hol = merged_data['Feiertage'].to_numpy()
    hol = hol / np.max(hol)
    train_hol = hol[:idx]
    test_hol = hol[idx:]
    ...
    with pm.Model() as model:
        ...
        μ = trend + w_h * weather + hol_h * holiday + cov_h * cov
        ...
        output_file = f"{data_path}/WHCT_{material_name}_{customer_name}.h5"
        save_model(output_file, material_name, customer_name, "WHCT", trace,
